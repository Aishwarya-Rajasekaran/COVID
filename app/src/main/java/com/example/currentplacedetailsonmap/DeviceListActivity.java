...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                ...
                {
                    Log.i(TAG,"bluetooth type - Phone"+bluetoothClass.getDeviceClass());
                }
                else
                {
                    Log.i(TAG,"bluetooth type - Not Phone"+bluetoothClass.getDeviceClass());
                }
            }
        } else {
        ...
        Log.i(TAG,"count"+pairedDevicesArrayAdapter.getCount());
    }
    ...
    private void returnNewDeviceCount() {
        ...
        intent.putExtra(EXTRA_DEVICE_COUNT,no_phone );

        Log.i(TAG,"new_devices_count"+mNewDevicesArrayAdapter.getCount());
                ...
                if (device.getBondState() != BluetoothDevice.BOND_BONDED) {
                    if (device.getName() != null) {
                        ...
                        if(bluetoothClass.getDeviceClass() ==BluetoothClass.Device.PHONE_SMART)
                        {
                            ...
                            Log.i("Filtering: non phone",device.getName());
                        }
